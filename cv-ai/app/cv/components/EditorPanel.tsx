...
export function EditorPanel({
  ...
  return (
    <>
      ...
      />
      <aside
        className={`no-print fixed left-0 top-0 z-40 flex h-screen w-[min(88vw,360px)] shrink-0 flex-col overflow-hidden border-r border-zinc-200 bg-white shadow-[18px_0_45px_rgba(15,23,42,0.14)] transition-transform duration-300 dark:border-[#173757] dark:bg-[#081525] xl:static xl:z-auto xl:max-h-screen xl:w-[460px] xl:translate-x-0 xl:shadow-none ${
      ...
      <header className="border-b border-zinc-200 bg-gradient-to-r from-white to-slate-50 px-4 py-4 transition-colors duration-300 dark:border-[#173757] dark:from-[#0b1728] dark:to-[#07111f] sm:px-6 sm:py-5">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              aria-label="Editor sidebar хаах"
              className="grid h-9 w-9 place-items-center rounded-full border border-zinc-200 text-zinc-700 transition hover:bg-zinc-100 dark:border-[#25527f] dark:text-[#dcecff] dark:hover:bg-[#0b1e33] xl:hidden"
              onClick={onClose}
              type="button"
            >
              <X className="h-4 w-4" />
